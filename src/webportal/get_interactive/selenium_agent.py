...
class PlaywrightVisionAgent(ToolCallingAgent):
    """Agent for local browser automation with Playwright and vision capabilities"""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._additional_browser_options()
    ...
    def _additional_browser_options(self):
        """Additional browser options - override in subclasses if needed"""
        pass
...
SeleniumVisionAgent = PlaywrightVisionAgent
